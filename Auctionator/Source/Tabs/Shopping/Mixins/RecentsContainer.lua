...
function AuctionatorShoppingTabRecentsContainerMixin:SetupContent()
  ...
  self.ScrollBox = CreateFrame("Frame", baseName and (baseName .. "ScrollBox") or nil, self, "WowScrollBoxList")
  self.ScrollBox:SetPoint("TOPLEFT", 0, -2)
  self.ScrollBox:SetPoint("BOTTOMRIGHT", 0, 2)

  self.ScrollBar = CreateFrame("Slider", baseName and (baseName .. "ScrollBar") or nil, self, "WowTrimScrollBar")
